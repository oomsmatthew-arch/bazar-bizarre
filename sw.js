...
const CACHE = 'bazar-bizarre-v3.1';
...
const ASSETS = ['./','./index.html','./entertainment.html','./bazar-bizarre-spel.html','./projecten.html','./manifest.json',
  './js/inventaris-data.js','./js/inventaris.js','./js/projecten.js','./js/supabase.min.js',
